...
<body>
    ...
    <main>
        <section class="text-center container">
            <h1 class="fw-light">EVENT PERUSAHAAN</h1>
            <p class="lead" style="text-align: justify;">Halaman event perusahaan adalah sebuah bagian penting dalam situs web perusahaan yang dirancang khusus untuk menginformasikan tentang acara-acara yang diadakan atau diikuti oleh perusahaan tersebut. Halaman ini tidak hanya berfungsi sebagai kalender atau daftar acara, tetapi juga sebagai platform untuk mempromosikan, mengabadikan, dan berbagi informasi terkait dengan kegiatan-kegiatan yang berdampak pada perusahaan dan komunitas sekitarnya.</p>
            </div>
            </div>
        </section>
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="img/event1.jpg" width="100%" height="225">
                            <div class="card-body">
                                <h5 class="card-title">JALAN SANTAI</h5>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="img/event2.jpg" width="100%" height="225">
                            <div class="card-body">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <img src="img/event3.jpg" width="100%" height="225">
                            <div class="card-body">
